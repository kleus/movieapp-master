...
class MovieRepository {
  final String apiKey = "59533523cf4b15a9696280c401bed0a3";
  ...
  Future<MovieResponse> getPlayingMovies() async {
    var params = {"api_key": apiKey, "language": "ru-RU", "page": 1};
    try {
      Response response =
  ...
  Future<GenreResponse> getGenres() async {
    var params = {"api_key": apiKey, "language": "ru-RU"};
    try {
  ...
  Future<MovieResponse> getMovieByGenre(int id) async {
    var params = {"api_key": apiKey, "language": "ru-RU", "page": 1, "with_genres": id};
    try {
